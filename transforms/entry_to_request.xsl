...
<xsl:transform
	...
	<xsl:param name="COLLECTION" select="'infax/data/'" as="xs:string"/>
	...
	<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:dcterms="http:purl.org/dc/terms/">
		<rdf:Description rdf:about="$Source: $">
			...
			<dcterms:description>Converts <xsl:attribute name="Atom feed into a sequence of XProc c:request elements."></xsl:attribute></dcterms:description>
		</rdf:Description>
	</rdf:RDF>
